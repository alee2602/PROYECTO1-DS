...
# Ruta de la carpeta con los archivos .xls

def generate_csv_files(carpeta_entrada="data/raw", carpeta_salida = "data/csv"):
    """
    Converte archivos .xls a .csv en la carpeta especificada.
    """
